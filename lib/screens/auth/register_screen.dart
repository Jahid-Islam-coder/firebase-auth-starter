...
class _SignupScreenState extends State<SignupScreen> {
  ...
  // These controllers help us get what the user typed in each box
  ...
  @override
  void dispose() {
    // We must dispose these to keep the app fast
  ...
  Future<void> _signup() async {
    ...
    // Make sure they checked the box!
    if (!_agreeToTerms) {
    ...
    try {
      ...
      // Step 2: Send them a verification email
      await AuthService.instance.sendEmailVerification();

      // Step 3: Create a user object with their extra info
      ...
      // Step 4: Save that extra info to the Firestore database
  ...
  // Helper to translate Firebase codes into human words
  ...
  // Separated the main UI to keep build function cleaner
